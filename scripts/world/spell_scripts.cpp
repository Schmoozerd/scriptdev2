...
void AddSC_spell_scripts()
{
    ...
    pScript.newScript("spell_dummy_go");
    pScript->pEffectDummyGO = &EffectDummyGameObj_spell_dummy_go;

    pScript.newScript("spell_dummy_npc");
    pScript->pEffectDummyNPC = &EffectDummyCreature_spell_dummy_npc;
    pScript->pEffectAuraDummy = &EffectAuraDummy_spell_aura_dummy_npc;
}
