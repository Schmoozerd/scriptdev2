...
{
    ScriptRegistry pScript("example_gossip_codebox", false);
    pScript->pGossipHello = &GossipHello_example_gossip_codebox;
    pScript->pGossipSelect = &GossipSelect_example_gossip_codebox;
    pScript->pGossipSelectWithCode = &GossipSelectWithCode_example_gossip_codebox;
}
