...
{
    ScriptRegistry pScript("example_escort", false);
    pScript->GetAI = &GetAI_example_escort;
    pScript->pGossipHello = &GossipHello_example_escort;
    pScript->pGossipSelect = &GossipSelect_example_escort;
}
