...
{
    ScriptRegistry pScript("example_creature", false);
    pScript->GetAI = &GetAI_example_creature;
    pScript->pGossipHello = &GossipHello_example_creature;
    pScript->pGossipSelect = &GossipSelect_example_creature;
}
